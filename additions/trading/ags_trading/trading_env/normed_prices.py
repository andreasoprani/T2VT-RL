...
from ags_trading.trading_env import TradingMain
from gym import spaces
import numpy as np

MAX_DERIVATIVE = 5.0

class TradingNormedPrices(TradingMain):

    def __init__(self, time_lag=60, **kwargs):
        # Calling superclass init
        super().__init__(time_lag=time_lag, **kwargs)
    ...
    def reset(self):
        ...
        self.derivatives = np.concatenate([np.zeros(self.time_lag), (self.prices[1:] - self.prices[0])])
