...
from ags_trading.vectorized_trading_env import VecTradingMain
from gym import spaces
import numpy as np

MAX_DERIVATIVE = 5.0

class VecTradingNormedPrices(VecTradingMain):
    ...
    def reset(self, **kwargs):
        ...
        self.derivatives = np.concatenate([np.zeros((self.n_selected_days, self.time_lag)), (self.prices[:,1:] - self.prices[:,0])], axis=1)
